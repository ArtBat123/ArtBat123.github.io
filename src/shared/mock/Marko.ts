...
export const referatResponseEng = [
  ...
  {
    title: 'Advantages and challenges of the automated approach',
...
export const referatResponseRu = [
  ...
  {
    title: 'Преимущества и вызовы автоматизированного подхода',
...
export const reportSearchResponse = [
  ...
  },
  {
    ...
    numberPhrase: 4,
    language: 'eng',
    phrase: 'algorithm for distribution of goods in the warehouse',
    search: 'Google',
...
export const LibraryResponse = [
  ...
  {
    title: 'Складская логистика: эффективность и оптимизация',
...
export const UemkResponse = {
  ...
  lectures: [
    ...
    {
      title: 'Классы и объектно-ориентированное программирование в TypeScript',
    ...
    {
      title: 'Продвинутые возможности TypeScript: Декораторы и модули',
      pathDocument: '/uemkMarko/6.docx',
    },
    {
      title: 'Интеграция TypeScript с JavaScript и реальное применение',
